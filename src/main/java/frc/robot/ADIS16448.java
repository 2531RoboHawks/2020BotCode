...
public class ADIS16448 extends GyroBase implements Gyro {
    ...
    private static class AcquireTask implements Runnable {
        ...
        public AcquireTask(final ADIS16448 imu) {
            this.imu = imu;
        }
     ...
     *
     */
    public ADIS16448(final IMUAxis yaw_axis, SPI.Port port, int cal_time) {
    m_yaw_axis = yaw_axis;
    m_spi_port = port;
